...
@section('title', __('locale.labels.coverage'))
            ...
            <div class="col-12">
                <div class="mb-1 mt-1">
                    ...
                    @can('edit plans')
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="bulk_actions">
                                ...
                                <a class="dropdown-item bulk-disable" href="#"><i
                                            data-feather="stop-circle"></i> {{ __('locale.datatables.bulk_disable') }}
                                </a>
                        ...
                        <div class="btn-group">
                            <a href="{{route('admin.sending-servers.add-coverage', $server->uid)}}"
    ...
    <script>
      $(document).ready(function() {
        ...
        let dataListView = $(".datatables-basic").DataTable({
          ...
          "serverSide": true,
          "ajax": {
            "url": "{{ route('admin.sending-servers.coverage', $server->uid) }}",
            "dataType": "json",
            "type": "POST",
        ...
        Table.delegate(".get_coverage_status", "click", function() {
          ...
          let url = "{{ url(config('app.admin_path').'/sending-servers/'.$server->uid.'/coverage')}}" + "/" + coverage + "/active";
        ...
        Table.delegate(".action-price-delete", "click", function(e) {
          ...
          let url = "{{ url(config('app.admin_path').'/sending-servers/'.$server->uid.'/coverage')}}" + "/" + id + "/delete";
          Swal.fire({
          ...
          Swal.fire({
            ...
            if (result.value) {
              ...
              if (countriesIds.length > 0) {
                ...
                $.ajax({
                  url: "{{ route('admin.sending-server.coverage-bulk-actions', $server->uid) }}",
                  type: "POST",
                  data: {
                    _token: "{{csrf_token()}}",
                    action: "enable",
