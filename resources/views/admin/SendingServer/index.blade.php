    ...
    <section id="datatables-basic">
        <div class="mb-3 mt-2">
            ...
            @can('create sending_servers')
                <div class="btn-group">
                    <a href="{{route('admin.sending-servers.select')}}"
                       class="btn btn-success waves-light waves-effect fw-bold mx-1"> {{__('locale.buttons.new_server')}}
          ...
          columnDefs: [
            ...
            },
            {
              ...
              render: function(data, type, full) {
                ...
                if (full["gateway_wise_billing"] === true) {
                  returnUrl += "<a href=\"" + full["billing"] + "\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\" title=\"" + full["coverage"] + "\" class=\"text-success\">" +
                    feather.icons["globe"].toSvg({ class: "font-medium-4" }) +
                    "</a>";
                }
                return (
                  returnUrl
