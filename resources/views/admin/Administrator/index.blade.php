    ...
    <section id="datatables-basic">
        <div class="mb-3 mt-2">
            ...
            @can('create administrator')
                <div class="btn-group">
                    <a href="{{route('admin.administrators.create')}}" class="btn btn-success waves-light waves-effect fw-bold mx-1"> {{__('locale.buttons.create')}} <x-ds-icon name="plus-circle" /></a>
                </div>
            @endcan

            @can('view administrator')
                <div class="btn-group">
                    <a href="{{route('admin.administrators.export')}}" class="btn btn-info waves-light waves-effect fw-bold"> {{__('locale.buttons.export')}} <x-ds-icon name="file-text" /></a>
                </div>
            @endcan
