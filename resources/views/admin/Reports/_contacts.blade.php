<div id="datatables-basic">
    ...
    <div class="mb-3 mt-2">
        ...
        <div class="btn-group">
            <a href="{{ route('admin.reports.export.campaign', $campaign->uid) }}" class="btn btn-info waves-light waves-effect fw-bold"> {{__('locale.buttons.export')}} <i data-feather="file-text"></i></a>
        </div>
