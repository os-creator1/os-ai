                ...
                <x-card :title="__('locale.blacklist.add_new_blacklist')">
                            ...
                            <form class="form form-vertical" action="{{ route('admin.blacklists.store') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <x-button type="submit" icon="save" class="mr-1 mb-1">{{ __('locale.buttons.save') }}
                                        </x-button>

                                        <button type="reset" class="btn btn-outline-warning mr-1 mb-1"><x-ds-icon name="refresh-cw" /> {{ __('locale.buttons.reset') }}
                                        </button>
                                    </div>
