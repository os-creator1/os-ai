                ...
                <table class="table opt-out-keywords">
                    ...
                    @foreach ($opt_out_keywords as $keywords)
                        <tr>
                            ...
                            <td>
                                <span class='action-delete-optout-keyword text-danger' data-id='{{$keywords->uid}}' data-bs-toggle='tooltip' data-placement='top' title='{{__('locale.buttons.delete')}}'><x-ds-icon name="trash" class="feather-24" /></span>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
