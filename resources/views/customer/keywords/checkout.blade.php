                            ...
                            @if($taxAmount > 0)
                                ...
                                <h5>{{ trans('locale.labels.tax') }} ({{ trans('locale.labels.vat_percent', [
                                    'percent' => $taxRate,
                                            ...
                                            class="text-primary">{{ \App\Library\Tool::format_price($taxAmount,$keyword->currency->format) }} </span>
                                </h5>
                            @endif

                            <h5>{{ __('locale.labels.total_price') }}: <span
                                        class="text-primary">{{ \App\Library\Tool::format_price($price, $keyword->currency->format) }} </span>
                            </h5>
