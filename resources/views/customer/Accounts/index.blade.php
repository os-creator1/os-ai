        ...
        <div class="row match-height">
            <div class="col-12">
                ...
                <ul class="nav nav-pills mb-2 text-uppercase" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  @if (old('tab') == 'invoice' || old('tab') == null) active @endif" id="invoice-tab" data-bs-toggle="tab" aria-controls="invoice" href="#invoice" role="tab" aria-selected="true"><i data-feather="shopping-cart"></i> {{ __('locale.labels.invoices') }}</a>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane  @if (old('tab') == 'invoice' || old('tab') == null) active @endif" id="invoice" role="tabpanel" aria-labelledby="invoice-tab">
