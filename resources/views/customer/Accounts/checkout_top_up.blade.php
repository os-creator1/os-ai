                ...
                <div class="bs-stepper-content">
                    ...
                    <div id="cart" class="content" role="tabpanel" aria-labelledby="cart-trigger">
                        ...
                        <div class="row mt-1 mb-1">
                            <h5>{{ __('locale.plans.price') }}: <span
                                        class="text-primary">{{ \App\Library\Tool::format_price($amount, Auth::user()->customer->subscription->plan->currency->format) }} </span>
                            </h5>
                            ...
                            @if($taxAmount > 0)
                                ...
                                <h5>{{ trans('locale.labels.tax') }} ({{ trans('locale.labels.vat_percent', [
                                    'percent' => $taxRate,
                                            ...
                                            class="text-primary">{{ \App\Library\Tool::format_price($taxAmount, Auth::user()->customer->subscription->plan->currency->format) }} </span>
                                </h5>
                            @endif

                            <h5>{{ __('locale.labels.total_price') }}: <span
                                        class="text-primary">{{ \App\Library\Tool::format_price($totalAmount, Auth::user()->customer->subscription->plan->currency->format) }} </span>
                            </h5>


                            <h5>{{ __('locale.plans.number_of_units') }}: <span
                                        class="text-primary">{{ $sms_unit }}</span></h5>
                        </div>
                    ...
                    <div id="payment" class="content" role="tabpanel" aria-labelledby="payment-trigger">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <input type="hidden" value="{{ $sms_unit }}" name="sms_unit">
                            <input type="hidden" value="{{ $amount }}" name="balance">
