...
@section('content')
    ...
    <section id="datatables-basic">
        <div class="mb-3 mt-2">
            ...
            @if(Auth::user()->can('buy_numbers') )
                <div class="btn-group">
                    <a href="{{route('customer.numbers.buy')}}"
                       class="btn btn-success waves-light waves-effect fw-bold mx-1"> {{__('locale.phone_numbers.buy_number')}}
