...
class FundingAttemptTerminalEventDispatchTest extends TestCase
{
    ...
    private function businessWithAutoRechargeConfigured(): array
    {
        ...
        app(UsageWalletManager::class)->configureAutoRecharge($business, true, '2000000', '5000000', (string) UsageWalletManager::BUSINESS_MONTHLY_AUTO_RECHARGE_MAXIMUM_MICRO, $customer->user_id);
