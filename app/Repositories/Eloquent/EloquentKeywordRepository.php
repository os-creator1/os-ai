...
// ✅ Call getOrdersController() on the PaypalServerSdkClient instance
                            ...
                            $checkout_session = \Stripe\Checkout\Session::create([
                                ...
                                'line_items'           => [[
                                    'price_data' => [
                                        ...
                                        'unit_amount'  => Helper::getStripeAmount($price, $keyword->currency->code),
                                        'product_data' => [
                                            'name' => $item_name,
                                        ],
                                    ],
                    ...
                    case PaymentMethods::TYPE_PAYU:
                        ...
                        $signature = "$credentials->client_secret~$credentials->client_id~keyword$keyword->uid~$totalAmount~$keyword->currency->code";
                    ...
                    case PaymentMethods::TYPE_RAZORPAY:
                        ...
                        try {
                            ...
                            $link = $api->paymentLink->create([
                                ...
                                'callback_url'    => route('customer.keywords.payment_success', $keyword->uid),
                                'callback_method' => 'get',
                            ]);
