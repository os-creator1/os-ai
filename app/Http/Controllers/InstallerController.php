<?php
    ...
    class InstallerController extends Controller
    {
        ...
        public function welcome()
        {
            ...
            if (str_contains($currentUrl, 'https')) {
                AppConfig::setEnv('URL_FORCE_HTTPS', 'true');
            } else {
                AppConfig::setEnv('URL_FORCE_HTTPS', 'false');
            }
        ...
        public function database(Request $request): JsonResponse
        {
            ...
            if (isset($response['status'])) {
                ...
                AppConfig::setEnv('APP_VERSION', config('app.version'));
