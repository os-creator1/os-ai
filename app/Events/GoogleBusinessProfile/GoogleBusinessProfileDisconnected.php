...
/**
 * GBP Slice A contract §19.5 — a Business disconnected; stored authorization was destroyed (§13.5).
 *
 ...
 */
class GoogleBusinessProfileDisconnected implements ShouldDispatchAfterCommit
{
    use Dispatchable;
